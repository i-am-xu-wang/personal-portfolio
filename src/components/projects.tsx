...
function Project({
  ...
  return (
    <section
      ...
      relative mb-3 sm:mb-8 last:mb-0 hover:bg-gray-200 transition sm:group-even:pl-8 
    ...
    >
      <div className="pt-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex h-full flex-col sm:group-even:ml-[18rem]">
        ...
        <div className="flex py-2 justify-start">
          <a
            className="mr-4 text-gray-700 hover:text-gray-950 flex items-center gap-2 hover:scale-[1.01] active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
            href={demoUrl}
            target="_blank"
